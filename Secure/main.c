...
{
    (void)num;
    printf("                                NSC: Secure Yellow LED On call by NSC\n");
    PD2 = 0;
    return 0;
}
...
{
    (void)num;
    printf("                                NSC: Secure Yellow LED Off\n");
    PD2 = 1;
    return 1;
}
...
uint32_t GetSystemCoreClock(void)
{
		printf("                                NSC: System core clock = %d.\n\n", SystemCoreClock);
    return SystemCoreClock;
}

int32_t LED_On(void)
{
	  printf("S : S-Green LED On\n");
    PD3 = 0;
    //PC1_NS = 0;
    return 0;
}
